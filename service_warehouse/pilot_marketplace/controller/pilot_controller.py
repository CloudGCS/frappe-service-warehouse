...
from service_warehouse.pilot_marketplace.doctype.pilot_profile.pilot_profile import _duration_value_to_seconds
...
def upsert_pilot_flight(**kwargs):
    ...
    log.flight_hours = _duration_value_to_seconds(kwargs.get("flight_hours"))
